...
(function(){
  ...
  var plates={
    ...
    rift:{key:'rift',symbol:'RFT',label:'균열',name:'불안정균열',subtitle:'고위험 고화력 장판',tags:['리스크','폭딜','후반'],effect:'피해 +62% · 과열',best:'고레벨 주력 딜러 · 중반 병목 구간',caution:'리스크가 큰 만큼 아무 타워나 올리면 손해를 볼 수 있습니다.',summary:'불안정균열은 가장 강한 공격 보너스를 주지만 과열 리스크가 있는 하이리스크 장판입니다. 잘 쓰면 전장을 크게 압축하지만 운영 난도가 높습니다.',tips:'고레벨 주력 딜러를 올리고, 군중 제어 타워와 같이 써서 리스크를 줄이세요. 초반보다 중후반 핵심 구간에 배치하는 편이 안전합니다.'}
  };
...
(function(){
  ...
  renderPlateDetail=function(key){
    ...
    e.detail.innerHTML=''
      ...
      +'<div class="armoryComboPanel"><div class="armoryPanelTitle">Effect Summary</div><div class="armoryInlineStatGrid">'+statCell('핵심 효과',p.effect)+statCell('추천 배치',p.best)+statCell('공명 보너스','같은 색상/계열 배치 시 피해 +12% · 공속 +4%')+statCell('주의 사항',p.caution)+'</div></div>'
