...
/* ===== v141-combat-hud-edge-alignment ===== */
(function(){
  'use strict';
  if(window.PRD_COMBAT_HUD_EDGE_ALIGNMENT_V141) return;
  window.PRD_COMBAT_HUD_EDGE_ALIGNMENT_V141 = true;
  function install(){
    var id = 'prd-combat-hud-edge-alignment-v141';
    var css = `
body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudTopLine,
body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudLeft,
body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudRight{
  position:fixed!important;
  left:0!important;
  top:0!important;
  width:0!important;
...
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTopMiniHud{
  position:fixed!important;
  left:10px!important;
  right:8px!important;
  top:calc(6px + var(--prd-status-top-offset,0px))!important;
  width:auto!important;
  height:28px!important;
  display:flex!important;
...
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyStage{
  ...
  background:linear-gradient(135deg,rgba(7,13,32,.80),rgba(35,46,62,.66))!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 6px 18px rgba(0,0,0,.24)!important;
  pointer-events:none!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyStage .mjMiniLabel{
  display:block!important;
  color:#c9d8e8!important;
  font:900 7px/1 'Noto Sans KR',Pretendard,system-ui,sans-serif!important;
  letter-spacing:0!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyStageValue{
  display:block!important;
  color:#fff!important;
  font:900 13px/1 'Orbitron','Noto Sans KR',system-ui,sans-serif!important;
  letter-spacing:0!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources{
...
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjResourcePill{
  width:auto!important;
  height:28px!important;
  min-height:28px!important;
  max-height:28px!important;
  ...
  border-radius:999px!important;
  border:1px solid rgba(148,220,255,.16)!important;
  background:linear-gradient(135deg,rgba(17,22,43,.78),rgba(28,27,48,.64))!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 8px 20px rgba(0,0,0,.20)!important;
  pointer-events:none!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjGoldPill{min-width:69px!important;}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjCorePill{min-width:60px!important;}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources i{
...
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjMoneyIcon{
  background:linear-gradient(135deg,#fff7ad,#fbbf24)!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjCoreIcon{
  background:linear-gradient(135deg,#ffc0cb,#fb7185)!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources b{
  color:#ffe680!important;
  font:900 13px/1 'Orbitron','Noto Sans KR',system-ui,sans-serif!important;
  letter-spacing:0!important;
  text-shadow:0 0 12px rgba(255,220,110,.22)!important;
}
body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjCorePill b{
  color:#fb7f9a!important;
  text-shadow:0 0 12px rgba(251,113,133,.24)!important;
}
	@media (orientation:portrait){
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTopMiniHud{
	    left:8px!important;
	    right:8px!important;
	    top:calc(12px + var(--prd-status-top-offset,72px))!important;
  ...
  body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjGoldPill{min-width:57px!important;}
  body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources .mjCorePill{min-width:49px!important;}
  body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyResources i{
  ...
  body.prd-combat-ui-active:not(.prd-map-ui-active) #mjTinyStageValue{
    font-size:11px!important;
	  ...
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #field .fieldTopControls,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudOverlay .fieldTopControls,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudTopLine .fieldTopControls{
	    right:calc(8px + env(safe-area-inset-right,0px))!important;
	    top:calc(12px + var(--prd-status-top-offset,72px))!important;
	    gap:8px!important;
	    align-items:flex-end!important;
	  }
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #field .fieldTopControls .fieldIconBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #field .fieldTopControls #towerMenuBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #field .fieldTopControls #audioBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudOverlay .fieldTopControls .fieldIconBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudOverlay .fieldTopControls #towerMenuBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudOverlay .fieldTopControls #audioBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudTopLine .fieldTopControls .fieldIconBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudTopLine .fieldTopControls #towerMenuBtn,
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudTopLine .fieldTopControls #audioBtn{
	...
	@media (orientation:landscape) and (max-height:520px){
	  ...
	  body.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudTopLine .fieldTopControls{
    right:calc(8px + env(safe-area-inset-right,0px))!important;
    top:calc(42px + var(--prd-status-top-offset,0px))!important;
    gap:8px!important;
    align-items:flex-end!important;
  }
  body.prd-combat-ui-active:not(.prd-map-ui-active) #field .fieldTopControls .fieldIconBtn,
...
@media (orientation:portrait) and (max-width:420px){
  ...
  body.prd-vp-portrait.prd-combat-ui-active:not(.prd-map-ui-active) #combatHudCommands button{
    ...
    if(old && old.textContent === css && old.parentElement && !old.nextElementSibling) return;
    if(old) old.remove();
    var st = document.createElement('style');
    st.id = id;
    st.textContent = css;
    (document.head || document.documentElement).appendChild(st);
	  ...
	  window.addEventListener('orientationchange', function(){ setTimeout(install, 60); setTimeout(install, 240); }, {passive:true});
	  window.addEventListener('pageshow', install, {passive:true});
	  var reinstallQueued = false;
	  function queueReinstall(){
	    if(reinstallQueued) return;
	  ...
	  try{
	    var styleRoot = document.head || document.documentElement;
	    new MutationObserver(function(records){
	      for(var i = 0; i < records.length; i++){
	        for(var j = 0; j < records[i].addedNodes.length; j++){
	          var node = records[i].addedNodes[j];
	          if(node && node.id !== 'prd-combat-hud-edge-alignment-v141' && (node.tagName === 'STYLE' || node.tagName === 'LINK')){
	            queueReinstall();
	            return;
	          }
	        }
	      }
	    }).observe(styleRoot, {childList:true});
	  }catch(_err){}
	  function reinstallSoon(){
	    setTimeout(install, 0);
	    setTimeout(install, 90);
	    setTimeout(install, 260);
	    setTimeout(install, 520);
	  }
	  ['click','pointerdown','touchstart','keyup'].forEach(function(ev){
	    window.addEventListener(ev, reinstallSoon, {capture:true, passive:true});
	    document.addEventListener(ev, reinstallSoon, {capture:true, passive:true});
	  });
	  setTimeout(install, 80);
	  setTimeout(install, 500);
	  setTimeout(install, 1200);
	  setInterval(function(){ if(!document.hidden) install(); }, 240);
	})();
